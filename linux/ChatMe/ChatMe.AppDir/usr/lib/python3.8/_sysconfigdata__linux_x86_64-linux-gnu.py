...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/local/build/python/bin',
 'BINLIBDEST': '/local/build/python/lib/python3.8',
 ...
 'CONFIG_ARGS': "'--prefix=/local/build/python' '--without-doc-strings' "
                "'--enable-ipv6' '--without-ensurepip'",
 'CONFINCLUDEDIR': '/local/build/python/include',
 'CONFINCLUDEPY': '/local/build/python/include/python3.8',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/local/build/Python-3.8.3/coverage.info',
 'COVERAGE_REPORT': '/local/build/Python-3.8.3/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++',
 'DESTDIRS': '/local/build/python /local/build/python/lib '
             '/local/build/python/lib/python3.8 '
             '/local/build/python/lib/python3.8/lib-dynload',
 'DESTLIB': '/local/build/python/lib/python3.8',
 'DESTPATH': '',
 'DESTSHARED': '/local/build/python/lib/python3.8/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/local/build/python/include /local/build/python/include '
                   '/local/build/python/include/python3.8 '
                   '/local/build/python/include/python3.8',
 'INCLUDEDIR': '/local/build/python/include',
 'INCLUDEPY': '/local/build/python/include/python3.8',
 ...
 'LDVERSION': '3.8',
 'LIBC': '',
 'LIBDEST': '/local/build/python/lib/python3.8',
 'LIBDIR': '/local/build/python/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/local/build/python/lib/pkgconfig',
 'LIBPL': '/local/build/python/lib/python3.8/config-3.8-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/local/build/python/lib/python3.8',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/local/build/python/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/local/build/python/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/local/build/Python-3.8.3',
 'abs_srcdir': '/local/build/Python-3.8.3',
 'datarootdir': '/local/build/python/share',
 'exec_prefix': '/local/build/python',
 'prefix': '/local/build/python',
 'srcdir': '.'}
